  ...
  render() {
    return (<div>
      ...
      <Widget
        ...
        cloudName={'bebrucato'} // your cloudinary account cloud name. 
        // Located on https://cloudinary.com/console/
        uploadPreset={'whhpami4'} // check that an upload preset exists and check mode is signed or unisgned
        ...
        onFailure={(err)=>console.log(err)} // add failure callback -> returns 'response.error' + 'response.result'
        ...
        apiKey={228136178295652} // cloudinary API key -> number format
